...
class Dijkstra(object):
    def run(self,mapa,start,end):
        ...
        while(len(vectorOfLabeled)!= nodosEnUno):
            ...
            movements=[[-1,-1,1.4], #Movimiento diagonales
                       [0,-1,1],
                       [1,-1,1.4],
                       [-1,0,1],
                       [1,0,1],
            ...
            '''movements=[          #Movimientos verticales y horizontales
                        [0,-1,1],
                        [-1,0,1],
                        [1,0,1],
                        [0,1,1]
...
RED   = pg.Color('red')
YELLOW   = pg.Color('yellowgreen')
# light shade of the button
color_light = (170,170,170)

# dark shade of the button
color_dark = (100,100,100)
smallfont = pg.font.SysFont('Calibri', 30)
    ...
    for event in pg.event.get():
        ...
        if event.type == pg.MOUSEBUTTONDOWN:
            ...
            if 10 <= mouse[0] <= 150 and 10 <= mouse[1] <= 40:
                camino,mapavisited,costs=search.run(mapaAlg,start,goal)

                for point in camino:
                    rect = (point[1]*tile_size, point[0]*tile_size, tile_size, tile_size)
                    pg.draw.rect(background,YELLOW , rect)
